    ...
    <div id="Feed" className={tema === "escuro" ? "escuro-fundo-cinza" : "claro-fundo-bege"}>
        ...
        <div className="mobileHeaderContent">
          <div className="mobileLogo">
            <span className="mobileLogoText">
              Ideia<span className="mobileLogoBlue">fy</span>
            </span>
          </div>
          <button
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebarNav">
          <button className="navItem active" title="Home">
            <HomeIcon />
          </button>
          <button className="navItem" title="Buscar" onClick={() => setShowSearchModal(true)}>
            <SearchIcon />
          </button>
          <button className="navItem" title="Notificações">
            <NotificationIcon />
          </button>
          <button className="navItem" title="Mensagens">
            <MessageIcon />
          </button>
          <button className="navItem" title="Configurações">
            <SettingsIcon />
          </button>
        </nav>
